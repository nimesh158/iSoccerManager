...
@interface SoccerManagerGameController (Private)

@end

@implementation SoccerManagerGameController
...
{	
	...
	{	
		...
		[_director addSceneWithKey:@"league" scene:scene];
		[scene release];
		...
		scene = [[EPLScene alloc] init];
		[_director addSceneWithKey:@"epl" scene:scene];
		[scene release];
		
		scene = [[SPLScene alloc] init];
		[_director addSceneWithKey:@"spl" scene:scene];
		[scene release];
		
		scene = [[TeamScene alloc] init];
		[_director addSceneWithKey:@"teamscene" scene:scene];
		[scene release];
		
		scene = [[SetupTeamScene alloc] init];
		[_director addSceneWithKey:@"setup" scene:scene];
		[scene release];
		
		scene = [[ViewTeam alloc] init];
		[_director addSceneWithKey:@"viewteam" scene:scene];
		[scene release];
		
		scene = [[ToBeImplemented alloc] init];
		[_director addSceneWithKey:@"tobeimplemented" scene:scene];
		[scene release];
